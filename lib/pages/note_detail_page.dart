...
class NoteDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final contenWidth = screenWidht > 1100 ? 900.0 : screenWidht;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            note.color.withOpacity(0.34),
            note.color.withOpacity(0.09),
          ],
        ),
  ...
  Widget _informationGrid(BuildContext context) {
    ...
    return GridView(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 20,
        mainAxisSpacing: 20,
        childAspectRatio: isWideLayout ? 3.5 : 4,
      ),
      children: [
        _informationCard(
  ...
  String _timeDisplayText(BuildContext context) {
    ...
    final startTimeText =
        note.startTime?.format(context) ?? '--:--';
    final endTimeText =
        note.endTime?.format(context) ?? '--:--';
